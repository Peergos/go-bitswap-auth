...
func TestEmpty(t *testing.T) {
	...
	if len(sim.InterestedSessions(cids, []auth.Want{}, []auth.Want{})) > 0 {
		t.Fatal("Expected no interest")
	}
}
...
func TestBasic(t *testing.T) {
	...
	ses1 := uint64(1)
	ses2 := uint64(2)
	cids1 := testutil.GenerateWants(2)
	cids2 := append(testutil.GenerateWants(1), cids1[1])
	...
	if len(sim.InterestedSessions(cids1, []auth.Want{}, []auth.Want{})) != 1 {
	...
	if len(sim.InterestedSessions(cids1[:1], []auth.Want{}, []auth.Want{})) != 1 {
		t.Fatal("Expected 1 session")
	}
	if len(sim.InterestedSessions(cids1[1:], []auth.Want{}, []auth.Want{})) != 2 {
...
func TestInterestedSessions(t *testing.T) {
	...
	if len(sim.InterestedSessions(cids, []auth.Want{}, []auth.Want{})) != 1 {
		t.Fatal("Expected 1 session")
	}
	if len(sim.InterestedSessions(cids[0:1], []auth.Want{}, []auth.Want{})) != 1 {
		t.Fatal("Expected 1 session")
	}
	if len(sim.InterestedSessions([]auth.Want{}, cids, []auth.Want{})) != 1 {
		t.Fatal("Expected 1 session")
	}
	if len(sim.InterestedSessions([]auth.Want{}, cids[0:1], []auth.Want{})) != 1 {
		t.Fatal("Expected 1 session")
	}
	if len(sim.InterestedSessions([]auth.Want{}, []auth.Want{}, cids)) != 1 {
		t.Fatal("Expected 1 session")
	}
	if len(sim.InterestedSessions([]auth.Want{}, []auth.Want{}, cids[0:1])) != 1 {
		t.Fatal("Expected 1 session")
	}
}
...
func TestRemoveSessionInterested(t *testing.T) {
	...
	res := sim.RemoveSessionInterested(ses1, []auth.Want{cids1[0]})
	if len(res) != 1 {
